...
$(document).ready(function () {
    ...
    $(".lp_footer .lp_icons").addClass(
        (
            LP_STYLE.lp_style_like_button == 1 ||
            LP_STYLE.lp_style_love_button == 1 ||
            LP_STYLE.lp_style_dark_light_mode_button == 1
        ) ? 'has_element' : ''
    );
    ...
    let main_chat_color = (LP_STYLE.lp_style_main_color) ? LP_STYLE.lp_style_main_color : '#e84667';
